...
% Finisci di argomentare su pipeline poi:
% - Problema del cammino critico
% - Gang Scheduler vs Space Sharing
...
L'unità che si occuperà della traduzione degli indirizzi è l'MMU. Questa unità dato un indirizzo logico lo tradurrà in uno fisico in base ad uno schema seguito. Elenchiamo delle possibili gestioni di traduzione di indirizzi.

\subsection{Base and Bound, Segmentazione, Paginazione}

\paragraph{Base and Bound} Si definisce una base ed un offset 
